...
@Component({
  selector: 'app-upload007',
  templateUrl: './upload007.component.html',
  styleUrls: ['./upload007.component.css']
})
export class Upload007Component implements OnInit {

  IsFile: boolean = false;
  URLExcel: string = environment.APIUploadRootURL + environment.Download + "/ToChucLongBe.xlsx"; 
  ...
  Upload() {
    ...
    this.UploadService.PostToChucLongBeByExcelFileAsync().subscribe(
      res => {        
