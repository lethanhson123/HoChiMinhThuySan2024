...
@Component({
  selector: 'app-upload008',
  templateUrl: './upload008.component.html',
  styleUrls: ['./upload008.component.css']
})
export class Upload008Component implements OnInit {

  IsFile: boolean = false;
  URLExcel: string = environment.APIUploadRootURL + environment.Download + "/ToChucNuoiNhuyenThe001.xlsx"; 
  ...
  Upload() {
    ...
    this.UploadService.PostToChucNuoiNhuyenThe001ByExcelFileAsync().subscribe(
      res => {        
