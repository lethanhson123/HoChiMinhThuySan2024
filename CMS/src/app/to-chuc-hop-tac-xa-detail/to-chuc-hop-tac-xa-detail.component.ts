...
@Component({
  selector: 'app-to-chuc-hop-tac-xa-detail',
  templateUrl: './to-chuc-hop-tac-xa-detail.component.html',
  styleUrls: ['./to-chuc-hop-tac-xa-detail.component.css']
})
export class ToChucHopTacXaDetailComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ToChucHopTacXaDetailComponent>,
  ...
  ToChucSave() {
    this.ToChucService.IsShowLoading = true;
    this.ToChucService.FormData.ParentID = environment.DanhMucToChucIDHopTacXa;
