...
@Component({
  selector: 'app-thanh-vien003',
  templateUrl: './thanh-vien003.component.html',
  styleUrls: ['./thanh-vien003.component.css']
})
export class ThanhVien003Component implements OnInit {
