...
@Component({
  selector: 'app-to-chuc-ho-nuoi',
  templateUrl: './to-chuc-ho-nuoi.component.html',
  styleUrls: ['./to-chuc-ho-nuoi.component.css']
})
export class ToChucHoNuoiComponent implements OnInit {
  ...
  ToChucDownload() {
    ...
    this.DownloadService.ExportToChucHoNuoiToExcelAsync().subscribe(
      res => {
