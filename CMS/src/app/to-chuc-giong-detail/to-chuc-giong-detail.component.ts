...
@Component({
  selector: 'app-to-chuc-giong-detail',
  templateUrl: './to-chuc-giong-detail.component.html',
  styleUrls: ['./to-chuc-giong-detail.component.css']
})
export class ToChucGiongDetailComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ToChucGiongDetailComponent>,
  ...
  DanhMucLoaiHinhSearch() {
    this.DanhMucLoaiHinhService.ComponentGetAllToListAsync(this.ToChucService);
  }
  ...
  ToChucSave() {
    this.ToChucService.IsShowLoading = true;
    this.ToChucService.FormData.ParentID = environment.DanhMucToChucIDGiong;
