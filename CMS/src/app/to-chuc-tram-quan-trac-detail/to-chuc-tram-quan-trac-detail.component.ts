...
@Component({
  selector: 'app-to-chuc-tram-quan-trac-detail',
  templateUrl: './to-chuc-tram-quan-trac-detail.component.html',
  styleUrls: ['./to-chuc-tram-quan-trac-detail.component.css']
})
export class ToChucTramQuanTracDetailComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ToChucTramQuanTracDetailComponent>,
  ...
  ToChucSave() {
    this.ToChucService.IsShowLoading = true;
    this.ToChucService.FormData.ParentID = environment.DanhMucToChucIDTramQuanTrac;
