...
@Component({
  selector: 'app-to-chuc-giong001',
  templateUrl: './to-chuc-giong001.component.html',
  styleUrls: ['./to-chuc-giong001.component.css']
})
export class ToChucGiong001Component implements OnInit {
