...
import { ToChucLongBeService } from 'src/app/shared/ToChucLongBe.service';

import * as maplibregl from 'maplibre-gl';

@Component({
  selector: 'app-to-chuc-long-be-detail',
  templateUrl: './to-chuc-long-be-detail.component.html',
  styleUrls: ['./to-chuc-long-be-detail.component.css']
})
export class ToChucLongBeDetailComponent implements OnInit {
  ...
  @ViewChild('ToChucLongBeSort') ToChucLongBeSort: MatSort;
  @ViewChild('ToChucLongBePaginator') ToChucLongBePaginator: MatPaginator;

  constructor(
    private dialog: MatDialog,
    public dialogRef: MatDialogRef<ToChucLongBeDetailComponent>,
    ...
    public ToChucLongBeService: ToChucLongBeService,
  ...
  ToChucLongBeSearch() {
    this.ToChucLongBeService.BaseParameter.ParentID = this.ToChucService.FormData.ID;
    this.ToChucLongBeService.SearchByParentID(this.ToChucLongBeSort, this.ToChucLongBePaginator, this.ToChucService);
  }
  ToChucLongBeSave(element: ToChucLongBe) {
    element.ParentID = this.ToChucService.FormData.ID;
    this.ToChucLongBeService.FormData = element;
    this.NotificationService.warn(this.ToChucLongBeService.ComponentSaveByParentID(this.ToChucLongBeSort, this.ToChucLongBePaginator, this.ToChucService));
  }
  ToChucLongBeDelete(element: ToChucLongBe) {
    this.ToChucLongBeService.BaseParameter.ID = element.ID;
    this.NotificationService.warn(this.ToChucLongBeService.ComponentDeleteByParentID(this.ToChucLongBeSort, this.ToChucLongBePaginator, this.ToChucService));
  }
