...
@Component({
  selector: 'app-to-chuc-cua-hang-detail',
  templateUrl: './to-chuc-cua-hang-detail.component.html',
  styleUrls: ['./to-chuc-cua-hang-detail.component.css']
})
export class ToChucCuaHangDetailComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ToChucCuaHangDetailComponent>,
  ...
  ToChucSave() {
    this.ToChucService.IsShowLoading = true;
    this.ToChucService.FormData.ParentID = environment.DanhMucToChucIDCuaHang;
