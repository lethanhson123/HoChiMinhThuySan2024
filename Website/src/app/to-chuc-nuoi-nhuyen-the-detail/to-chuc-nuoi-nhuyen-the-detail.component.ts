...
import { ToChucNguyenVatLieuService } from 'src/app/shared/ToChucNguyenVatLieu.service';
import { ToChucNuoiNhuyenThe } from 'src/app/shared/ToChucNuoiNhuyenThe.model';
import { ToChucNuoiNhuyenTheService } from 'src/app/shared/ToChucNuoiNhuyenThe.service';

import * as maplibregl from 'maplibre-gl';

@Component({
  selector: 'app-to-chuc-nuoi-nhuyen-the-detail',
  templateUrl: './to-chuc-nuoi-nhuyen-the-detail.component.html',
  styleUrls: ['./to-chuc-nuoi-nhuyen-the-detail.component.css']
})
export class ToChucNuoiNhuyenTheDetailComponent implements OnInit {
  ...
  @ViewChild('ToChucNguyenVatLieuSort') ToChucNguyenVatLieuSort: MatSort;
  @ViewChild('ToChucNguyenVatLieuPaginator') ToChucNguyenVatLieuPaginator: MatPaginator;

  @ViewChild('ToChucNuoiNhuyenTheSort') ToChucNuoiNhuyenTheSort: MatSort;
  @ViewChild('ToChucNuoiNhuyenThePaginator') ToChucNuoiNhuyenThePaginator: MatPaginator;

  constructor(
    private dialog: MatDialog,
    public dialogRef: MatDialogRef<ToChucNuoiNhuyenTheDetailComponent>,
    ...
    public ToChucNguyenVatLieuService: ToChucNguyenVatLieuService,
    public ToChucNuoiNhuyenTheService: ToChucNuoiNhuyenTheService,
  ...
  ToChucSearchHoNuoi() {
    ...
    this.ToChucService.GetByParentIDToListAsync().subscribe(
      res => {
        this.ToChucService.ListHoNuoi = (res as ToChuc[]).sort((a, b) => (a.Name > b.Name ? 1 : -1));
      },
      err => {
      },
      () => {
  ...
  ToChucSave() {
    this.ToChucService.IsShowLoading = true;
    this.ToChucService.FormData.ParentID = environment.DanhMucToChucIDLongBe;
  ...
  ToChucNguyenVatLieuSearch() {
    this.ToChucNguyenVatLieuService.BaseParameter.ParentID = this.ToChucService.FormData.ID;
    this.ToChucNguyenVatLieuService.SearchByParentID(this.ToChucNguyenVatLieuSort, this.ToChucNguyenVatLieuPaginator, this.ToChucService);
  }
  ToChucNguyenVatLieuSave(element: ToChucNguyenVatLieu) {
    element.ParentID = this.ToChucService.FormData.ID;
    this.ToChucNguyenVatLieuService.FormData = element;
    this.NotificationService.warn(this.ToChucNguyenVatLieuService.ComponentSaveByParentID(this.ToChucNguyenVatLieuSort, this.ToChucNguyenVatLieuPaginator, this.ToChucService));
  }
  ToChucNguyenVatLieuDelete(element: ToChucNguyenVatLieu) {
    this.ToChucNguyenVatLieuService.BaseParameter.ID = element.ID;
    this.NotificationService.warn(this.ToChucNguyenVatLieuService.ComponentDeleteByParentID(this.ToChucNguyenVatLieuSort, this.ToChucNguyenVatLieuPaginator, this.ToChucService));
  }

  ToChucNuoiNhuyenTheSearch() {
    this.ToChucNuoiNhuyenTheService.BaseParameter.ParentID = this.ToChucService.FormData.ID;
    this.ToChucNuoiNhuyenTheService.SearchByParentID(this.ToChucNuoiNhuyenTheSort, this.ToChucNuoiNhuyenThePaginator, this.ToChucService);
  }
  ToChucNuoiNhuyenTheSave(element: ToChucNuoiNhuyenThe) {
    element.ParentID = this.ToChucService.FormData.ID;
    this.ToChucNuoiNhuyenTheService.FormData = element;
    this.NotificationService.warn(this.ToChucNuoiNhuyenTheService.ComponentSaveByParentID(this.ToChucNuoiNhuyenTheSort, this.ToChucNuoiNhuyenThePaginator, this.ToChucService));
  }
  ToChucNuoiNhuyenTheDelete(element: ToChucNuoiNhuyenThe) {
    this.ToChucNuoiNhuyenTheService.BaseParameter.ID = element.ID;
    this.NotificationService.warn(this.ToChucNuoiNhuyenTheService.ComponentDeleteByParentID(this.ToChucNuoiNhuyenTheSort, this.ToChucNuoiNhuyenThePaginator, this.ToChucService));
  }
