...
@Component({
  selector: 'app-to-chuc-giong',
  templateUrl: './to-chuc-giong.component.html',
  styleUrls: ['./to-chuc-giong.component.css']
})
export class ToChucGiongComponent implements OnInit {
  ...
  ToChucDownload() {
    ...
    this.DownloadService.ExportToChucGiongToExcelAsync().subscribe(
      res => {
