...
@Component({
  selector: 'app-thanh-vien004',
  templateUrl: './thanh-vien004.component.html',
  styleUrls: ['./thanh-vien004.component.css']
})
export class ThanhVien004Component implements OnInit {
  ...
  ThanhVienSearch() {
    this.ThanhVienService.BaseParameter.ParentID = 5;
